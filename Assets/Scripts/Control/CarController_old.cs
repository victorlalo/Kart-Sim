...
public class CarController_old : MonoBehaviour
{
    ...
    void Accelerate()
    {
        //if (rb.velocity.magnitude < CarParams.topSpeed && throttle > 0f)
    ...
    void Steer()
    {
        ...
        {
            //currRotation += steering * CarParams.turnRadius;
            rb.MoveRotation(Quaternion.Euler(transform.up * currRotation * Time.fixedDeltaTime));
